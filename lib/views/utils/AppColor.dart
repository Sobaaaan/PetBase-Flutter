...
class AppColor {
  static Color primary = Color(0xfffb7800);
  static Color primarySoft = Color(0xfffb7800);
  ...
  static LinearGradient bottomShadow = LinearGradient(colors: [
    Color.fromARGB(255, 120, 66, 16).withOpacity(0.2),
    Color.fromARGB(255, 120, 66, 16).withOpacity(0)
